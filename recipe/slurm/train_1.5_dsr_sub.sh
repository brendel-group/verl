...
exp_name="${MODEL_PATH}_${dataset_name}_n_${n_resp_per_prompt}_bsz_${train_prompt_bsz}_epochs_${num_epochs}_kl_coef_${kl_coef}_slurm"
...
CKPTS_DIR=${CKPTS_DIR:-"${RAY_DATA_HOME}/verl_checkpoints/self_distillation_emnlp/${exp_name}"}
