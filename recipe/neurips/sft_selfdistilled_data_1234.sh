...
dir=$1
experiment_name=qwen_2.5_1.5b_base_sft_data_${dir}_1.5b_3b_7b_14b_epochs_${epochs}_lr_${lr}_bsz_${bsz}_micro_bsz_${micro_bsz}_total_training_steps_${total_training_steps}
...
torchrun --standalone --nnodes=1 --nproc_per_node=8 \
    ...
    data.train_files=/fast/pmayilvahanan/post_training/self_distilled_datasets_neurips/${dir}/train_common_indices_1.5_3_7_14.parquet \
