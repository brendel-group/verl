...
clipping_mode="tapr" # "tapr", "selective_negative", "standard"
exp_name="${MODEL_PATH}_${dataset_name}_n_${n_resp_per_prompt}_bsz_${train_prompt_bsz}_epochs_${num_epochs}_kl_coef_${kl_coef}_use_ref_for_generation_${USE_REF_FOR_GENERATION}_clipping_mode_${clipping_mode}_redo_w_actual_tapering"
...
python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.actor.clipping_mode=${clipping_mode} \
