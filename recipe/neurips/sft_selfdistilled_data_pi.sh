...
dir=$1
experiment_name=qwen_2.5_math_1.5b_base_sft_data_${dir}_epochs_${epochs}_lr_${lr}_bsz_${bsz}_micro_bsz_${micro_bsz}_total_training_steps_${total_training_steps}
...
torchrun --standalone --nnodes=1 --nproc_per_node=${n_gpus_per_node} \
    ...
    +trainer.save_checkpoint_steps=5 \
