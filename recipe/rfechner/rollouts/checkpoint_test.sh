...
num_rollouts=128  # Number of rollouts per prompt
num_questions=128  # Number of questions to take from the dataset
...
CHECKPOINT="${RAY_DATA_HOME}/out/entropy/Qwen/Qwen2.5-1.5B_math_entropy_coef_0.01_20250716_165418/global_step_15/actor" # checkpoint to load.
