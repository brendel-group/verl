#!/usr/bin/env bash
set -euxo pipefail
echo "Qwen 7B rollout collection. Setting up..."
# ------------------------------------------------------------------------------
...
num_rollouts=1024  # Number of rollouts per prompt
num_questions=1024  # Number of questions to take from the dataset
