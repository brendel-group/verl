...
project_name='self_distillation'
...
MODEL_PATH=/fast/pmayilvahanan/post_training/verl_checkpoints/self_distillation_neurips/Qwen/qwen_2.5_1.5b_base_sft_data_Qwen2.5-1.5B_openai_math_n_32_bsz_512_epochs_1_kl_coef_0.0_step_0_epochs_15_lr_1e-6_bsz_512/global_step_5
dataset_name='openai_math'
model_name_succinct=qwen_2.5_1.5b_base_sft_data_Qwen2.5-1.5B_openai_math_n_32_bsz_512_epochs_1_kl_coef_0.0_step_0_epochs_15_lr_1e-6_bsz_512_global_step_5
...
CKPTS_DIR=${CKPTS_DIR:-"${RAY_DATA_HOME}/post_training/verl_checkpoints/self_distillation/Qwen/sft_plus_rl/${exp_name}"}
