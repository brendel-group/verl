...
train_prompt_bsz=64 # 512 works for 7B n = 8
multiplier=2 # 3 works for 7B n = 8
...
CKPTS_DIR=${CKPTS_DIR:-"${RAY_DATA_HOME}/post_training/verl_checkpoints/self_distillation/${exp_name}"}
#TRAIN_FILE=${TRAIN_FILE:-"${RAY_DATA_HOME}/datasets/${dataset_name}/train.parquet"}
TRAIN_FILE=${TRAIN_FILE:-"${RAY_DATA_HOME}/datasets/rl_training_one_example/pi1_r128.parquet"} # change this to above
