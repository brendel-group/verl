...
train_prompt_bsz=1024 # 512 works for 7B n = 8
...
exp_name="${MODEL_PATH}_${dataset_name}_n_${n_resp_per_prompt}_bsz_${train_prompt_bsz}_epochs_${num_epochs}_kl_coef_${kl_coef}_use_ref_for_generation_${USE_REF_FOR_GENERATION}"
