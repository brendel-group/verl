...
MODEL_PATH=tiiuae/Falcon3-3B-Base
dataset_name='openai_math'

exp_name="${MODEL_PATH}_${dataset_name}_n_${n_resp_per_prompt}_bsz_${train_prompt_bsz}_epochs_${num_epochs}_kl_coef_${kl_coef}_math_verify"
