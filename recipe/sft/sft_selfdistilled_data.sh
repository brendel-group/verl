...
dir=Qwen2.5-7B_deepscaler_n_8_bsz_1024_epochs_1_kl_coef_0.0_step_0_all
experiment_name=qwen_2.5_7b_base_sft_data_${dir}_epochs_${epochs}_lr_${lr}_bsz_${bsz}_micro_bsz_${micro_bsz}
...
torchrun --standalone --nnodes=1 --nproc_per_node=8 \
    ...
    data.val_files=/fast/pmayilvahanan/post_training/self_distilled_datasets_neurips/${dir}/test.parquet \
    ...
    +trainer.save_checkpoint_steps=192 \
    +trainer.validate_every_n_steps=96 \
