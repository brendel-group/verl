...
dir=Qwen2.5-7B_pi1_r128_n_32_bsz_64_epochs_1_kl_coef_0.0_step_0_all
experiment_name=qwen_2.5_7b_base_sft_data_${dir}_epochs_${epochs}_lr_${lr}_bsz_${bsz}
save_path=/fast/pmayilvahanan/post_training/verl_checkpoints/self_distillation/Qwen/$experiment_name
...
torchrun --standalone --nnodes=1 --nproc_per_node=8 \
    ...
    data.train_files=/fast/pmayilvahanan/post_training/self_distilled_datasets/${dir}/train_5040.parquet \
    data.val_files=/fast/pmayilvahanan/post_training/self_distilled_datasets/${dir}/test.parquet \
    ...
    +trainer.save_checkpoint_steps=3 \
